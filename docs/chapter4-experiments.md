...
<img src="images/knn-architecture.svg" alt="KNN架构" style="max-width:100%;border:1px solid #e2e8f0;border-radius:8px;margin:16px 0" />
...
<img src="images/svm-architecture.svg" alt="SVM架构" style="max-width:100%;border:1px solid #e2e8f0;border-radius:8px;margin:16px 0" />
...
<img src="images/rf-architecture.svg" alt="RF架构" style="max-width:100%;border:1px solid #e2e8f0;border-radius:8px;margin:16px 0" />
...
<img src="images/adaboost-architecture.svg" alt="AdaBoost架构" style="max-width:100%;border:1px solid #e2e8f0;border-radius:8px;margin:16px 0" />
...
<img src="images/gcn-architecture.svg" alt="GCN架构" style="max-width:100%;border:1px solid #e2e8f0;border-radius:8px;margin:16px 0" />
